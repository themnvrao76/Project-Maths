...
class Derivative():
	...
	def HeaderLabel(self):
		...
		Lab2=Label(self.root,text="Solve Derivatives with Project Math",bg="BLACK",fg="White",
			font=("Arial",20,"bold"),relief=GROOVE,border=5)
		Lab2.pack(pady=20)
	...
	def DerivativeFrame(self):
		f1=LabelFrame(self.root,text="I Love Maths",bg="WHITE",fg="black",
			font=("Arial",15,"bold"),relief=GROOVE,border=5)
		f1.pack(fill=BOTH)
		...
		f3=LabelFrame(f2,text="Function",width=300,height=480,bg="WHITE",fg="black",
			font=("Arial",15,"bold"),relief=GROOVE,border=10)
